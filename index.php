				...
				<form action="login_db.php" method="post">
					<div class="panel panel-body login-form">
						<div class="text-center">
							<div class="icon-object border-warning-400 text-warning-400"><img src="imagess/thumbs/OSOLOGO.png" style="height: 80px;"></div>
							<h5 class="content-group-lg">OSO - Login <small class="display-block">Enter your credentials</small></h5>
						</div>
